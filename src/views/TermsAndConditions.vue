<template>
  <b-card title="Terms & Conditions">
    <b-card-text>
      Please read these terms and conditions carefully before using Our Service.
      This website isn't financial advice, always do your own research, we
    ...
    <b-card-text>
      ...
      <li>
        <span class="span-class">Affiliate </span>
        <span
      ...
      <li>
        <span class="span-class">Country </span>
        <span>refers to: United Kingdom</span>
      </li>
      <li>
      ...
      <li>
        <span class="span-class">Device </span>
        <span
      ...
      <li>
        <span class="span-class">Service </span>
        <span>refers to the Website.</span>
      </li>
      <li>
        <span class="span-class">Terms and Conditions</span>
        <span
      ...
      <li>
        <span class="span-class">Third-party Social Media Service </span>
        <span>
      ...
      <li>
        ...
        <span
          ...
          <a href="https://www.rugfreecoins.com/"
            >https://www.rugfreecoins.com/</a
          >
        </span>
      </li>
      <li>
        <span class="span-class">You </span>
        <span
          >mean the individual accessing or using the Service, or the company,
      ...
      <b-card-text class="pt-2"
        ...
        the use of the Service.</b-card-text
      >
      <b-card-text
      ...
      <b-card-text
        ...
        Conditions then You may not access the Service.</b-card-text
      >
      <b-card-text
        >You represent that you are over the age of 18. The Company does not
        permit those under 18 to use the Service.</b-card-text
      >
      <b-card-text
      ...
      <b-card-text
        ...
        limitation if You breach these Terms and Conditions.</b-card-text
      >
      <b-card-text
      ...
      <b-card-text
        ...
        USD if You haven't purchased anything through the Service.</b-card-text
      >
      <b-card-text
      ...
      <h2 class="pt-2">Promotions</h2>
      <h4 class="pt-2">Audited coins</h4>
      <b-card-text
        ...
        industry standards.</b-card-text
      >
      <b-card-text
        >Rugfreecoins.com development team will preview the report
        publicly.</b-card-text
      >
      <b-card-text
        >We give 95% assurance to the public that those audited coins are rug
        pull-free and scams will not likely happen.
      </b-card-text>
      <b-card-text
        >We will keep tracking the coins daily and make sure no suspicious
        activity will occur.
      </b-card-text>
      <h4>Paid promotions</h4>
      <b-card-text
        >Only audited coins will be listed in the paid promotions
        section.</b-card-text
      >
      <b-card-text>These are paid advertisements.</b-card-text>
      <b-card-text
        >These are verified coins by the rugfreecoins.com development team.
      </b-card-text>
      <b-card-text
        >If we have reports or if we notice any suspicious activity even after
        the audits we reserve the right to delist these coins as soon as we can
        from this section.
      </b-card-text>
      <h2 class="pt-2">Governing Law</h2>
      <b-card-text
        >The laws of the Country, excluding its conflicts of law rules, shall
        govern this Terms and Your use of the Service. Your use of the
        Application may also be subject to other local, state, national, or
        international laws.</b-card-text
      >
      <h2 class="pt-2">Disputes Resolution</h2>
      <b-card-text
        >If You have any concern or dispute about the Service, You agree to
        first try to resolve the dispute informally by contacting the
        Company.</b-card-text
      >
      <h2 class="pt-2">For European Union (EU) Users</h2>
      <b-card-text
        >If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which you are resident
        in.
      </b-card-text>
      <h2 class="pt-2">United States Legal Compliance</h2>
      <b-card-text
      ...
      <h2 class="pt-2">Severability and Waiver</h2>
      <h4 class="pt-2">Severability</h4>
      <b-card-text
        >If any provision of these Terms is held to be unenforceable or invalid,
        such provision will be changed and interpreted to accomplish the
        objectives of such provision to the greatest extent possible under
        applicable law and the remaining provisions will continue in full force
        and effect.</b-card-text
      >
      <h4 class="pt-2">Waiver</h4>
      <b-card-text
      ...
      <h2 class="pt-2">Translation Interpretation</h2>
      <b-card-text
      ...
      <h2 class="pt-2">Changes to These Terms and Conditions</h2>
      <b-card-text
